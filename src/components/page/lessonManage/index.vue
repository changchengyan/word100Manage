...
//     },
    ...
    methods: {
        ...
        filterLesson:function(){
          ...
          //   "",
          // ).then(function(res) {
          //     console.log("lessonInfo", res);
          //   that.lessonInfo.cards = res.data;
          // });
        ...
        filterArr(arr,filterName){
          ...
          //   // return  item.activitys.activity_desc==filterName
          //   return   _.filter(item.testArr,activity=>{
          //     return   activity.name==filterName
          //   })
          //   // item.testArr.name==filterName
          // })
          let tmpArr=[];
  ...
  watch: {
    lessonCard:{
      handler(val,oldval){  
        ...
        // console.log(val.checkEnd)
        if(val.checkMid==true){
          // this.lessonInfo.cards=this.PositiveSequence(this.lessonInfo.cards,'activitys.activity_desc')  
